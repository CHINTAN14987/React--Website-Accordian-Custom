    ...
    <div className=" aboutContainer">
      ...
      <div className="fluid-container">
        <Row className="justify-content-center">
          <Col md={2} className="  sideContainer m-2">
          ...
          {displayedContent && (
            <Col md={8} className="rightContainer m-2">
              ...
              <p>
                Our Company is a global IT and Engineering solutions provider
                ...
                combination of deep industry knowledge and expertise in building
                capabilities on short notice makes us a strategic partner for
                our customers.
              </p>
              <p>
                Partnering with PeopleNTech gives our customers access to some
                of the finest talent in the industry. Our highly qualified team
                of professionals leverages their skills and experiences in order
                to design and integrate exceptionally successful products and
                strategies. These strategies are built with the aim to empower
                our customers with the right tools and processes needed to
                achieve operating and financial goals.
              </p>
              <p>
                Our seasoned professionals come experienced in a broad spectrum
                of technologies that range from cutting-edge technologies to
                legacy systems, enabling us to successfully service a wide
